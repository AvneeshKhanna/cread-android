...
public class SearchHashTagFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_search_hash_tag
                , container
                , false);
    }
        ...
        RxSearchObservable.fromView(searchView)
                ...
                .switchMap(new Function<String, ObservableSource<JSONObject>>() {
                    ...
                    public ObservableSource<JSONObject> apply(String s) throws Exception {
                        ...
                        //Network call
                        return getSearchObservableServer(mSearchKeyWord, mLastIndexKey, SEARCH_TYPE_HASHTAG);
                    }
                })
    ...
    private void loadMoreData() {
        mCompositeDisposable.add(getSearchObservableServer(mSearchKeyWord, mLastIndexKey, SEARCH_TYPE_HASHTAG)
