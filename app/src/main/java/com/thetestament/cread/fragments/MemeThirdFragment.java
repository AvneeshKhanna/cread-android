...
public class MemeThirdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //inflate this view
        return inflater.inflate(R.layout.fragment_meme_third
                , container
                , false);
    }
    ...
    private void getWritePermissionForGallery() {
        ...
        if (Nammu.checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            ImageHelper.chooseImageFromGallery(MemeThirdFragment.this
    ...
    private void validateMemeCreation() {
        ...
        if (tvBottom.getText().toString().equals(getString(R.string.hint_text_meme))) {
            ViewHelper.getToast(getContext(), "Text field can't be empty");
        }
        //If empty
        else if (TextUtils.isEmpty(tvBottom.getText().toString().trim())) {
            ViewHelper.getToast(getContext(), "Text field can't be empty");
        } else {
