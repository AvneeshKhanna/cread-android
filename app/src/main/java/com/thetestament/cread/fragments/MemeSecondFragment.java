...
public class MemeSecondFragment extends Fragment {
    ...
    private void getWritePermissionForGallery() {
        ...
        if (Nammu.checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            ImageHelper.chooseImageFromGallery(MemeSecondFragment.this
                    , Constant.REQUEST_CODE_OPEN_GALLERY_FOR_MEME);
        } else {
            //We do not own this permission
            if (Nammu.shouldShowRequestPermissionRationale(MemeSecondFragment.this
                ...
                Nammu.askForPermission(MemeSecondFragment.this
                        , Manifest.permission.WRITE_EXTERNAL_STORAGE
