...
public class FontsHelper {
    ...
    public static final String FONT_TYPE_KHULA_REGULAR = "khula_regular.ttf";
    public static final String FONT_TYPE_PALANQUIN_REGULAR = "palanquin_regular.ttf";
    //endregion
    ...
    public static String[] fontTypes = {
            ...
            , FONT_TYPE_KHULA_REGULAR
            , FONT_TYPE_PALANQUIN_REGULAR
    };
    //endregion
    ...
    public static Typeface getFontType(String fontType, Context context) {
        switch (fontType) {
            ...
            case FONT_TYPE_KHULA_REGULAR:
                return ResourcesCompat.getFont(context, R.font.khula_regular);
            case FONT_TYPE_PALANQUIN_REGULAR:
                return ResourcesCompat.getFont(context, R.font.palanquin_regular);
            default:
                return ResourcesCompat.getFont(context, R.font.ubuntu_medium);
        }
    }
